    ...
    <>
      ...
      <div className="branch-wrap" id="route">
        <section className="section" id="about">
          ...
          <h2>会社概要</h2>
          <p>
            IT業界で20年以上、インフラからアプリ開発、ガバナンスまで幅広く携わってきました。その中で気づいたのは、AIによって個人でもできることが大きく広がった一方で、それをどう使いこなせばいいか分からない人がとても多いということ。
          </p>
          <p style={{ marginTop: 16 }}>
            特に個人事業主や小規模な組織では、頼れる相談相手がいないまま、ちょっとしたITの悩みを抱えたままになりがちです。Willoaは、その「ちょっとしたこと」を安心して聞ける、ITの何でも屋でありたいと思っています。
          </p>
