    ...
    <>
      ...
      <div className="branch-wrap" id="route">
        <section className="section" id="about">
          ...
          <h2>会社概要</h2>
          <p>
            IT業界で20年以上の経験があります。インフラからアプリケーション開発、ガバナンス・IT管理まで、幅広い領域に対応できるのが強みです。ここにAIを掛け合わせて、個人事業主・小規模組織でも頼みやすい形でご提供する「ITの何でも屋」です。
          </p>
          ...
          <p style={{ marginTop: 22 }}>
            大きな業者には頼みにくい「ちょっとしたこと」から、専門的な相談まで。企画・開発・運用まで代表ひとりで一貫して担当します。
          </p>
        </section>
