    ...
    <>
      ...
      <div className="branch-wrap" id="route">
        <section className="section" id="about">
          ...
          <h2>会社概要</h2>
          <p>
            ITベンダー・事業会社の両方で培った経験に、AIを掛け合わせて対応する「ITの何でも屋」です。ジャンルを問わず、IT・デジタルに関することなら基本的になんでも引き受けます。
          </p>
          ...
          <div className="facts">
            ...
            <div>
              対応範囲 <span>IT・デジタル全般</span>
            </div>
          </div>

          <p style={{ marginTop: 22 }}>
            大きな業者には頼みにくい「ちょっとしたこと」から、ちゃんとした専門相談まで。企画・開発・運用まで代表ひとりで一貫して担当します。
          </p>
        </section>
